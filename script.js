...
document.addEventListener('DOMContentLoaded', function () {
  let personas = []; // Lista completa de personas (Futbolistas, Profesionales)
  ...
  document.getElementById('tipoPersona').addEventListener('change', function () {
    ...
    if (tipo === 'futbolista') {
      document.querySelector('.futbolista-fields').style.display = 'block';
      document.querySelector('.profesional-fields').style.display = 'none';
    } else {
      document.querySelector('.futbolista-fields').style.display = 'none';
  ...
  function crearPersonaDesdeFormulario(tipoPersona) {
    ...
    if (tipoPersona === 'futbolista') {
      ...
      return new Futbolista(nuevoId, nombre, apellido, edad, equipo, posicion, cantidadGoles);
      ...
      return new Profesional(nuevoId, nombre, apellido, edad, titulo, facultad, anioGraduacion);
    }
  }
  ...
  function actualizarPersonaDesdeFormulario(persona) {
    ...
    if (persona instanceof Futbolista) {
      persona.equipo = document.getElementById('equipo').value;
      persona.posicion = document.getElementById('posicion').value;
      persona.cantidadGoles = parseInt(document.getElementById('cantidadGoles').value);
    } else if (persona instanceof Profesional) {
      persona.titulo = document.getElementById('titulo').value;
      persona.facultad = document.getElementById('facultad').value;
      persona.anioGraduacion = parseInt(document.getElementById('anioGraduacion').value);
    }
  }
  ...
  function aplicarFiltro() {
    if (filtroSeleccionado === 'futbolista') {
      return personas.filter(p => p instanceof Futbolista);
    } else if (filtroSeleccionado === 'profesional') {
      return personas.filter(p => p instanceof Profesional);
    } else {
  ...
  function validarFormularioABM() {
    ...
    if (tipoPersona === 'futbolista') {
      ...
      const cantidadGoles = parseInt(document.getElementById('cantidadGoles').value.trim());
      ...
      const anioGraduacion = parseInt(document.getElementById('anioGraduacion').value.trim());
      ...
      if (facultad === '') {
        errores.push("La facultad no puede estar vacía.");
        valido = false;
      }
